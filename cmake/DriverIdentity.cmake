...
function(configure_driver_identity target)
    ...
    message(STATUS "  FXVAD_ICON = \"${FXVAD_ICON}\"")
    ...
    set(DRIVER_CAT_NAME     "${FXVAD_ID}ntamd64.cat")

    set(DRIVER_SERVICE_NAME "${FXVAD_ID}")
    set(DRIVER_HARDWARE_ID  "ROOT\\${DRIVER_ID_UPPER}")

    set(DRIVER_PROVIDER_NAME "${FXVAD_DISPLAY_NAME}")
    set(DRIVER_DEVICE_NAME   "${FXVAD_DISPLAY_NAME} Virtual Audio Device")
    set(DRIVER_ENDPOINT_NAME "${FXVAD_DISPLAY_NAME} Speakers")
